...
public class WebSecurityConfig {
    ...
    private final RestConfig rsaKeys;

    public WebSecurityConfig(RestConfig rsaKeys) {
...
=======
                        ...
                        .requestMatchers("/api/usuarios/login-nfc").permitAll()
                        // Eventos requieren autenticación (cualquier rol)
